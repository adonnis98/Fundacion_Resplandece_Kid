...
namespace Fundacion_Resplandece_Kid
{
    internal class Program
    {
        ...
        MailAddress addressFrom = new MailAddress("fundacionresplandecekid@gmail.com", "Fundacion_Resplandece_Kid");
        MailAddress addressdestinatarioEmail = new MailAddress(destinatarioEmail);
        MailMessage message = new MailMessage(addressFrom, addressdestinatarioEmail);
        ...
        client.Port = 587;
            ...
            client.Credentials = new NetworkCredential("fundacionresplandecekid@gmail.com", "bfbopbjgkldvazyq");
            try
            {
                client.Send(message);
...
Console.WriteLine("\nAsegúrate de que la dirección de correo y la contraseña de aplicación sean correctas y que la configuración del servidor sea válida.");
            }
...
public static void DisplayMainMenu()
{
    while (true)
    {
        ...
        Console.WriteLine("║  6.  ENVIAR REPORTE DE BENEFICIARIOS POR CORREO       ║  ");// OJO ESTO AQUI NO SE COMO AGREGARLE AQUI SE SUPONE QUE DEBERIA IR EL REPORTE MEDICO Y OTRAS OBSERVACIONES
...
private static void CreateTutor()
{
    ...
    Console.Write("Ingrese el email del tutor: ");
